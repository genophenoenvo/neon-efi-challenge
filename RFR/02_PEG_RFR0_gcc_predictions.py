...
for k in range(0,8):
    ...
    file_name = os.path.join(dirname, 'PEG_RFR0', 'models', "model_"+site_list[k]+".pkl")
...
outputs_path = os.path.join(dirname, 'PEG_RFR0', 'outputs/')
output_file_name= "PEG_RFR0_predictions_" + str(date.today().strftime("%m-%d-%y"))+ ".csv"
